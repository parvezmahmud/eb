...
class Question(models.Model):
    ...
    option2 = models.TextField(max_length=255, blank=True, null=True)
    option2_is_correct = models.BooleanField(default=False)
    option3 = models.TextField(max_length=255, blank=True, null=True)
    option3_is_correct = models.BooleanField(default=False)
    option4 = models.TextField(max_length=255, blank=True, null=True)
