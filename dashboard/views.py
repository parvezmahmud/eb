...
def bunit(request):
    ...
    create_question = 'create-question-bunit'
...
def cunit(request):
    ...
    create_question = 'create-question-cunit'
    ...
    context = {
        ...
        'create_question': create_question,
        'topic': 'C-UNIT',
        'edit': 'bunit-bangla-card-edit',
        'dltc': 'bunit-bangla-card-delete',
        'edit_test': edit_question
    }
    return render(request, 'dashboard/unit.html', context)
